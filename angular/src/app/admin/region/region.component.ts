...
export class RegionComponent implements OnInit {
  ...
  add() {
    this.openDialog(new Region(), 'Region').subscribe(result => {
      if (result) {
        this.uow.regions.post(result).subscribe(
          r => {
  ...
  edit(o: Region) {
    this.openDialog(o, 'Region').subscribe((result: Region) => {
      if (result) {
        this.uow.regions.put(result.id, result).subscribe(
          r => {
            this.update.next(true);
          }
        );
